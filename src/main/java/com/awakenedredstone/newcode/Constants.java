...
public class Constants {
    ...
    public static final Path TEMPLATE_PATH = Path.of(FileUtils.getUserDirectoryPath(), "fabricmodgen", "template");
    public static final Path CACHE_PATH = Path.of(FileUtils.getUserDirectoryPath(), "fabricmodgen", "cache");
